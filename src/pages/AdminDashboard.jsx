  ...
  async function fetchAnime() {
    try {
      ...
      if (d && d.anime && d.anime.length > 0) {
        ...
        setCustomAnime([
          { id: 9001, mal_id: 9001, title: "Solo Leveling Season 2: Arise from the Shadow", type: "TV", year: 2025, episodes: 12, score: 9.2, image: "https://cdn.myanimelist.net/images/anime/1090/141019l.jpg", trailer_url: "https://www.youtube.com/embed/94r_Y4vP5C8", synopsis: "After surviving the Double Dungeon and unlocking the mysterious System, Sung Jinwoo continues his ascent as the world's only leveling hunter.", genres: "Action, Fantasy, Adventure", studios: "A-1 Pictures", is_hidden: false, isDemo: true, trending: true, top_rated: true },
          { id: 9002, mal_id: 9002, title: "Chainsaw Man - The Movie: Reze Arc", type: "Movie", year: 2024, episodes: 1, score: 9.1, image: "https://cdn.myanimelist.net/images/anime/1806/126216l.jpg", trailer_url: "https://www.youtube.com/embed/1vRzTzW6c6c", synopsis: "Denji meets a mysterious girl named Reze in a cafe who shows him affection he has never experienced before, but she harbors a deadly secret.", genres: "Action, Supernatural, Romance", studios: "MAPPA", is_hidden: false, isDemo: true, trending: true, top_rated: true },
          { id: 9003, mal_id: 9003, title: "One Punch Man Season 3", type: "TV", year: 2025, episodes: 12, score: 8.9, image: "https://cdn.myanimelist.net/images/anime/12/76049l.jpg", trailer_url: "https://www.youtube.com/embed/e_q8D6bX604", synopsis: "The Monster Association launches an all-out war against the Hero Association while Saitama is drawn into the subterranean battlefield.", genres: "Action, Comedy, Sci-Fi", studios: "J.C.Staff", is_hidden: false, isDemo: true, trending: true, top_rated: true },
          { id: 9004, mal_id: 9004, title: "Bleach: Thousand-Year Blood War - Part 3", type: "TV", year: 2024, episodes: 13, score: 9.0, image: "https://cdn.myanimelist.net/images/anime/1764/126627l.jpg", trailer_url: "https://www.youtube.com/embed/t0d2z9j39q8", synopsis: "The war between the Soul Reapers and the Quincy reaches the Royal Palace as Ichigo confronts Yhwach.", genres: "Action, Supernatural", studios: "Pierrot", is_hidden: false, isDemo: true, trending: false, top_rated: true },
          { id: 9005, mal_id: 9005, title: "Jujutsu Kaisen Season 3: Culling Game", type: "TV", year: 2025, episodes: 24, score: 9.3, image: "https://cdn.myanimelist.net/images/anime/1792/138022l.jpg", trailer_url: "https://www.youtube.com/embed/8n_7y7e44t0", synopsis: "Kenjaku initiates the Culling Game—a battle royale involving newly awakened sorcerers across Japan.", genres: "Action, Supernatural, Dark Fantasy", studios: "MAPPA", is_hidden: false, isDemo: true, trending: true, top_rated: true }
        ])
      }
    } catch {
      setCustomAnime([
