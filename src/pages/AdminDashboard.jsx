    ...
    try {
      ...
      if (d && d.anime && d.anime.length > 0) {
        ...
        setCustomAnime([
          ...
          { id: 9003, mal_id: 9003, title: "One Punch Man Season 3", type: "TV", year: 2025, episodes: 12, score: 8.9, image: "https://cdn.myanimelist.net/images/anime/1160/122627l.jpg", trailer_url: "https://www.youtube.com/embed/e_q8D6bX604", synopsis: "The Monster Association launches an all-out war against the Hero Association while Saitama is drawn into the subterranean battlefield.", genres: "Action, Comedy, Sci-Fi", studios: "J.C.Staff", is_hidden: false, isDemo: true, trending: true, top_rated: false },
