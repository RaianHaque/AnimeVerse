        ...
        <section className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="relative rounded-2xl overflow-hidden glass">
            <div className="absolute inset-0">
              <img src={featured.image} alt={featured.title} className="w-full h-full object-cover opacity-20 blur-sm" />
            ...
            <div className="relative grid md:grid-cols-[250px_1fr] gap-8 p-8">
              <img src={featured.image} alt={featured.title} className="rounded-xl w-full max-w-[250px] shadow-[0_0_30px_rgba(180,79,255,0.2)]" />
